...
am_libpbc_la_OBJECTS = libpbc_la-field.lo libpbc_la-z.lo \
	...
	libpbc_la-fasterfp.lo libpbc_la-montfp.lo libpbc_la-multiz.lo \
	...
	libpbc_la-singular.lo libpbc_la-param.lo libpbc_la-a_param.lo \
	libpbc_la-d_param.lo libpbc_la-e_param.lo libpbc_la-f_param.lo \
	libpbc_la-g_param.lo
...
ACLOCAL = ${SHELL} /home/russ/Downloads/pbc-0.5.4/missing --run aclocal-1.10
ALLOCA = 
AMTAR = ${SHELL} /home/russ/Downloads/pbc-0.5.4/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/russ/Downloads/pbc-0.5.4/missing --run autoconf
AUTOHEADER = ${SHELL} /home/russ/Downloads/pbc-0.5.4/missing --run autoheader
AUTOMAKE = ${SHELL} /home/russ/Downloads/pbc-0.5.4/missing --run automake-1.10
AWK = mawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/russ/Downloads/pbc-0.5.4/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
...
STRIP = strip
VERSION = 0.5.4
abs_builddir = /home/russ/Downloads/pbc-0.5.4
abs_srcdir = /home/russ/Downloads/pbc-0.5.4
abs_top_builddir = /home/russ/Downloads/pbc-0.5.4
abs_top_srcdir = /home/russ/Downloads/pbc-0.5.4
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = $(SHELL) /home/russ/Downloads/pbc-0.5.4/install-sh
...
libpbc.la: $(libpbc_la_OBJECTS) $(libpbc_la_DEPENDENCIES) 
...
benchmark/$(am__dirstamp):
	@$(MKDIR_P) benchmark
	@: > benchmark/$(am__dirstamp)
benchmark/benchmark$(EXEEXT): $(benchmark_benchmark_OBJECTS) $(benchmark_benchmark_DEPENDENCIES) benchmark/$(am__dirstamp)
	@rm -f benchmark/benchmark$(EXEEXT)
	$(LINK) $(benchmark_benchmark_OBJECTS) $(benchmark_benchmark_LDADD) $(LIBS)
benchmark/ellnet$(EXEEXT): $(benchmark_ellnet_OBJECTS) $(benchmark_ellnet_DEPENDENCIES) benchmark/$(am__dirstamp)
	@rm -f benchmark/ellnet$(EXEEXT)
	$(LINK) $(benchmark_ellnet_OBJECTS) $(benchmark_ellnet_LDADD) $(LIBS)
benchmark/timersa$(EXEEXT): $(benchmark_timersa_OBJECTS) $(benchmark_timersa_DEPENDENCIES) benchmark/$(am__dirstamp)
	@rm -f benchmark/timersa$(EXEEXT)
	$(LINK) $(benchmark_timersa_OBJECTS) $(benchmark_timersa_LDADD) $(LIBS)
pbc/$(am__dirstamp):
	@$(MKDIR_P) pbc
	@: > pbc/$(am__dirstamp)
pbc/pbc$(EXEEXT): $(pbc_pbc_OBJECTS) $(pbc_pbc_DEPENDENCIES) pbc/$(am__dirstamp)
	@rm -f pbc/pbc$(EXEEXT)
...
libpbc_la-field.lo: arith/field.c
	...
	mv -f $(DEPDIR)/libpbc_la-field.Tpo $(DEPDIR)/libpbc_la-field.Plo
...
libpbc_la-z.lo: arith/z.c
	...
	mv -f $(DEPDIR)/libpbc_la-z.Tpo $(DEPDIR)/libpbc_la-z.Plo
...
libpbc_la-naivefp.lo: arith/naivefp.c
	...
	mv -f $(DEPDIR)/libpbc_la-naivefp.Tpo $(DEPDIR)/libpbc_la-naivefp.Plo
...
libpbc_la-fastfp.lo: arith/fastfp.c
	...
	mv -f $(DEPDIR)/libpbc_la-fastfp.Tpo $(DEPDIR)/libpbc_la-fastfp.Plo
...
libpbc_la-fp.lo: arith/fp.c
	...
	mv -f $(DEPDIR)/libpbc_la-fp.Tpo $(DEPDIR)/libpbc_la-fp.Plo
...
libpbc_la-fasterfp.lo: arith/fasterfp.c
	...
	mv -f $(DEPDIR)/libpbc_la-fasterfp.Tpo $(DEPDIR)/libpbc_la-fasterfp.Plo
...
libpbc_la-montfp.lo: arith/montfp.c
	...
	mv -f $(DEPDIR)/libpbc_la-montfp.Tpo $(DEPDIR)/libpbc_la-montfp.Plo
...
libpbc_la-multiz.lo: arith/multiz.c
	...
	mv -f $(DEPDIR)/libpbc_la-multiz.Tpo $(DEPDIR)/libpbc_la-multiz.Plo
...
libpbc_la-dlog.lo: arith/dlog.c
	...
	mv -f $(DEPDIR)/libpbc_la-dlog.Tpo $(DEPDIR)/libpbc_la-dlog.Plo
...
libpbc_la-fieldquadratic.lo: arith/fieldquadratic.c
	...
	mv -f $(DEPDIR)/libpbc_la-fieldquadratic.Tpo $(DEPDIR)/libpbc_la-fieldquadratic.Plo
...
libpbc_la-poly.lo: arith/poly.c
	...
	mv -f $(DEPDIR)/libpbc_la-poly.Tpo $(DEPDIR)/libpbc_la-poly.Plo
...
libpbc_la-random.lo: arith/random.c
	...
	mv -f $(DEPDIR)/libpbc_la-random.Tpo $(DEPDIR)/libpbc_la-random.Plo
...
libpbc_la-init_random.lo: arith/init_random.c
	...
	mv -f $(DEPDIR)/libpbc_la-init_random.Tpo $(DEPDIR)/libpbc_la-init_random.Plo
...
libpbc_la-darray.lo: misc/darray.c
	...
	mv -f $(DEPDIR)/libpbc_la-darray.Tpo $(DEPDIR)/libpbc_la-darray.Plo
...
libpbc_la-symtab.lo: misc/symtab.c
	...
	mv -f $(DEPDIR)/libpbc_la-symtab.Tpo $(DEPDIR)/libpbc_la-symtab.Plo
...
libpbc_la-get_time.lo: misc/get_time.c
	...
	mv -f $(DEPDIR)/libpbc_la-get_time.Tpo $(DEPDIR)/libpbc_la-get_time.Plo
...
libpbc_la-utils.lo: misc/utils.c
	...
	mv -f $(DEPDIR)/libpbc_la-utils.Tpo $(DEPDIR)/libpbc_la-utils.Plo
...
libpbc_la-memory.lo: misc/memory.c
	...
	mv -f $(DEPDIR)/libpbc_la-memory.Tpo $(DEPDIR)/libpbc_la-memory.Plo
...
libpbc_la-extend_printf.lo: misc/extend_printf.c
	...
	mv -f $(DEPDIR)/libpbc_la-extend_printf.Tpo $(DEPDIR)/libpbc_la-extend_printf.Plo
...
libpbc_la-mpc.lo: ecc/mpc.c
	...
	mv -f $(DEPDIR)/libpbc_la-mpc.Tpo $(DEPDIR)/libpbc_la-mpc.Plo
...
libpbc_la-mnt.lo: ecc/mnt.c
	...
	mv -f $(DEPDIR)/libpbc_la-mnt.Tpo $(DEPDIR)/libpbc_la-mnt.Plo
...
libpbc_la-hilbert.lo: ecc/hilbert.c
	...
	mv -f $(DEPDIR)/libpbc_la-hilbert.Tpo $(DEPDIR)/libpbc_la-hilbert.Plo
...
libpbc_la-curve.lo: ecc/curve.c
	...
	mv -f $(DEPDIR)/libpbc_la-curve.Tpo $(DEPDIR)/libpbc_la-curve.Plo
...
libpbc_la-pairing.lo: ecc/pairing.c
	...
	mv -f $(DEPDIR)/libpbc_la-pairing.Tpo $(DEPDIR)/libpbc_la-pairing.Plo
...
libpbc_la-singular.lo: ecc/singular.c
	...
	mv -f $(DEPDIR)/libpbc_la-singular.Tpo $(DEPDIR)/libpbc_la-singular.Plo
...
libpbc_la-param.lo: ecc/param.c
	...
	mv -f $(DEPDIR)/libpbc_la-param.Tpo $(DEPDIR)/libpbc_la-param.Plo
...
libpbc_la-a_param.lo: ecc/a_param.c
	...
	mv -f $(DEPDIR)/libpbc_la-a_param.Tpo $(DEPDIR)/libpbc_la-a_param.Plo
...
libpbc_la-d_param.lo: ecc/d_param.c
	...
	mv -f $(DEPDIR)/libpbc_la-d_param.Tpo $(DEPDIR)/libpbc_la-d_param.Plo
...
libpbc_la-e_param.lo: ecc/e_param.c
	...
	mv -f $(DEPDIR)/libpbc_la-e_param.Tpo $(DEPDIR)/libpbc_la-e_param.Plo
...
libpbc_la-f_param.lo: ecc/f_param.c
	...
	mv -f $(DEPDIR)/libpbc_la-f_param.Tpo $(DEPDIR)/libpbc_la-f_param.Plo
...
libpbc_la-g_param.lo: ecc/g_param.c
	...
	mv -f $(DEPDIR)/libpbc_la-g_param.Tpo $(DEPDIR)/libpbc_la-g_param.Plo
...
benchmark_benchmark-benchmark.o: benchmark/benchmark.c
	...
	mv -f $(DEPDIR)/benchmark_benchmark-benchmark.Tpo $(DEPDIR)/benchmark_benchmark-benchmark.Po
...
benchmark_ellnet-ellnet.o: benchmark/ellnet.c
	...
	mv -f $(DEPDIR)/benchmark_ellnet-ellnet.Tpo $(DEPDIR)/benchmark_ellnet-ellnet.Po
...
benchmark_timersa-timersa.o: benchmark/timersa.c
	...
	mv -f $(DEPDIR)/benchmark_timersa-timersa.Tpo $(DEPDIR)/benchmark_timersa-timersa.Po
...
pbc_pbc-parser.tab.o: pbc/parser.tab.c
	...
	mv -f $(DEPDIR)/pbc_pbc-parser.tab.Tpo $(DEPDIR)/pbc_pbc-parser.tab.Po
...
pbc_pbc-lex.yy.o: pbc/lex.yy.c
	...
	mv -f $(DEPDIR)/pbc_pbc-lex.yy.Tpo $(DEPDIR)/pbc_pbc-lex.yy.Po
...
pbc_pbc-pbc.o: pbc/pbc.c
	...
	mv -f $(DEPDIR)/pbc_pbc-pbc.Tpo $(DEPDIR)/pbc_pbc-pbc.Po
...
pbc_pbc-pbc_getline.o: pbc/pbc_getline.c
	...
	mv -f $(DEPDIR)/pbc_pbc-pbc_getline.Tpo $(DEPDIR)/pbc_pbc-pbc_getline.Po
...
pbc_pbc-darray.o: misc/darray.c
	...
	mv -f $(DEPDIR)/pbc_pbc-darray.Tpo $(DEPDIR)/pbc_pbc-darray.Po
...
pbc_pbc-symtab.o: misc/symtab.c
	...
	mv -f $(DEPDIR)/pbc_pbc-symtab.Tpo $(DEPDIR)/pbc_pbc-symtab.Po
